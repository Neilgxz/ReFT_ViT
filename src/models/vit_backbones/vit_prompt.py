...
class PromptedTransformer(Transformer):
    def __init__(self, config, reft_config, prompt_config, img_size, vis):
...
class PromptedVisionTransformer(VisionTransformer):
    def __init__(
        self, model_type, reft_cfg, prompt_cfg,
        ...
        super(PromptedVisionTransformer, self).__init__(
            model_type, reft_cfg, img_size, num_classes, vis)
        ...
        self.transformer = PromptedTransformer(
            vit_cfg, reft_cfg, prompt_cfg, img_size, vis)
